...
import { idlFactory } from './BootcampLocalActor.did.js';
export { idlFactory } from './BootcampLocalActor.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.BOOTCAMPLOCALACTOR_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./BootcampLocalActor.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the BootcampLocalActor canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./BootcampLocalActor.did.js")._SERVICE>}
 */
export const BootcampLocalActor = createActor(canisterId);
