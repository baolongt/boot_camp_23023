...
import { idlFactory } from './simpleCalculator.did.js';
export { idlFactory } from './simpleCalculator.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.SIMPLECALCULATOR_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./simpleCalculator.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the simpleCalculator canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./simpleCalculator.did.js")._SERVICE>}
 */
export const simpleCalculator = createActor(canisterId);
